...
class Unit:
        ...
        def __init__(self, unit_name, unit_type, cost, attack, defense, movement):
                self.name = unit_name
...
class Rules:
        ...
        def __init__(self):
                ...
                #land units
                self.infantry = Unit("infantry", "land", 3, 1, 2, 1)
                self.artillary = Unit("artillary", "land", 4, 1, 2, 1)
